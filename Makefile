...
EMAIL = docker-orchestrate@josediazgonzalez.com
MAINTAINER = dokku
...
Deploys Docker Compose services with support for rolling updates, custom healthchecks, and container naming conventions.
endef
